...
namespace ClinicalReporting.Model.Repository
{
    ...
    public interface IBiochemistriesRepository
    {
        ...
        Biochemistry AddBiochemistry(Biochemistry biochemistry);
        List<Biochemistry> GetAllBiochemistry();
        Biochemistry FindBiochemistry(long id);
        Biochemistry UpdateBiochemistry(Biochemistry biochemistry);
        void RemoveBiochemistry(long id);
        Biochemistry GetWithChildren(long id);
        Biochemistry SaveBiochemistry(Biochemistry biochemistry);
        List<Biochemistry> Query(string query);
    }
    ...
    public class BiochemistryRepository : IBiochemistriesRepository, IDisposable
    {
        ...
        public List<Biochemistry> GetAllBiochemistry()
        {
            return Conn.Select<Biochemistry>();
        }

        public Biochemistry FindBiochemistry(long id)
        {
            return Conn.SingleById<Biochemistry>(id);
        }
        ...
        public void RemoveBiochemistry(long id)
        {
            Conn.DeleteById<Biochemistry>(id);
        }

        public Biochemistry GetWithChildren(long id)
        {
            var biochemistry = Conn.SingleById<Biochemistry>(id);
            // One To One 
            var patient = Conn.Select<Patient>().SingleOrDefault(a => a.PatientID == id);
        ...
        public List<Biochemistry> Query(string query)
        {
            return Conn.Select<Biochemistry>(query);
        }
        ...
        {
            return await Conn.SelectAsync<Biochemistry>(query);
        }
